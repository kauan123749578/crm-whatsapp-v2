...
export default function ChatWindow({ chatName, messages, onSendMessage, isLoading, onToggleSidebar, showSidebar, profilePicUrl }: Props) {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-zinc-950 relative">
      <div className="h-18 px-6 border-b border-zinc-800/50 flex items-center justify-between bg-gradient-to-r from-zinc-900/95 via-zinc-900/90 to-zinc-900/95 backdrop-blur-xl shadow-xl">
        <div className="flex items-center gap-4">
          ...
          >
            <span className="bg-gradient-to-br from-yellow-400 to-orange-500 bg-clip-text text-transparent text-xl">
